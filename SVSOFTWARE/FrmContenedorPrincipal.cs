...
namespace SVSOFTWARE
{
    public partial class FrmContenedorPrincipal : Form
    {
        ...
        {
            FrmMantenimientoClientes MantenimientoCliente = new FrmMantenimientoClientes();
        ...
        {
            FrmMantenimientoProductos MantenimientoPriducto = new FrmMantenimientoProductos();
            MantenimientoPriducto.MdiParent = this;
            MantenimientoPriducto.Show();
        }

        private void clientesToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            FrmConsultarCliente frmConsultarCliente = new FrmConsultarCliente();
            frmConsultarCliente.MdiParent = this;
        ...
        private void productosToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            frmConsultarProducto.MdiParent = this;
